    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        <div class="modal">
            <div class="modal-content">
                ...
                <form action="{{ route('toy.delete', $order->toy->id) }}" method="post">
                    @csrf
                    <button type="submit"
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            @if ($order->status === 'cancelled')
                <p class="text-xl text-red-500 font-bold text-center">This order is cancelled by the customer</p>
            @endif
            <main class="w-full flex-grow p-6">
                <div class=" p-4 w-full h-screen bg-white transition-transform dark:bg-gray-800" aria-hidden="false">
                    ...
                    <dl class="sm:mb-5">
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Description Of
                            Toys
                        </dt>
                    ...
                    <dl class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        @if ($order->status === 'cancelled')
                            <div
                                class="p-3 bg-gray-100 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Order Status
                                </dt>
                                <dd class="text-red-600 font-bold text-lg">
                                    Cancelled by customer</dd>
